    ...
    <body>
                    ...
                    <div class="row">
                        <div class="col-lg-12 tabbg">
                            <ul class="nav nav-tabs">
                                <li><a href="<c:url value="/invoices" />"><spring:message code="label.invoicelist.pageheader"></spring:message></a></li>
                                <li class="active"><a data-toggle="tab" href="#estimation"><spring:message code="label.pages.estimation"></spring:message></a></li>
                            </ul>

                            <!--<h1 class="page-header"><spring:message code="label.invoicelist.pageheader"></spring:message></h1>-->
                            
                            <div class="tab-content">
                                <div id="estimation" class="tab-pane fade in active"><br>
                        ...
                        <!--<div class="jumbotron"></div>-->
                            ...
                            <form action="/" method="POST" class="" enctype="utf8" id="addInvoiceForm" >
                             ...
                             <div class="estimateformdiv container-fluid">
                                 <fieldset>
                                    <h3 class="heading2">
                                        <label class="invlabel" style="background: infobackground;min-width: 50px"><spring:message code="label.estimation.estimationno"></spring:message></label>
                                        <input type="text" class="edit-input invoicelabel" name="estimatelabel" id="invoicelabel" value="" style="max-width: 150px"/>
                                        <label for="name" class="control-label invidlabel" style="background: infobackground;min-width: 50px;text-align: center">
                                            AUTO
                                        </label>
                                        <input type="text" class="edit-input" name="estimateno" id="invoiceid" value="0" style="max-width: 150px"/>
                                    </h3>
                                ...
                                <div class="form-group control-group ">
                                    <label class="col-sm-1"><spring:message code="label.estimation.customer"></spring:message></label>
                                    <span class="col-sm-3">
                                ...
                                <div class="form-group control-group ">
                                    <label class="col-sm-1"><spring:message code="label.estimation.date"></spring:message></label>
                                ...
                                <div class="form-group control-group ">
                                    <label class="col-sm-2" style="text-align: center"><spring:message code="label.estimation.duedate"></spring:message></label>
                                ...
                                <div class="detail container-fluid product-table">
                                    ...
                                    <div class="table-header">
                                        <div class="col-sm-3"><spring:message code="label.estimation.product"></spring:message></div>
                                        <div class="col-sm-3" style="width: 29%"><spring:message code="label.estimation.description"></spring:message></div>
                                        <div class="col-sm-1" style="width: 10%"><spring:message code="label.estimation.quantity"></spring:message></div>
                                        <div class="col-sm-1" style="width: 10%"><spring:message code="label.estimation.price"></spring:message></div>
                                        <div class="col-sm-1" style="width: 10%"><spring:message code="label.estimation.tax"></spring:message></div>
                                        <div class="col-sm-1" style="width:12%"><spring:message code="label.estimation.amount"></spring:message></div>
                                ...
                                <div class="container-fluid text-center form-inline">
                                    <div class="col-sm-4">
                                        <div class="form-group">
                                            <label><spring:message code="label.estimation.totalprice"></spring:message></label>
                                    ...
                                    <div class="col-sm-3">
                                        <div class="form-group">
                                            <label><spring:message code="label.estimation.totaltax"></spring:message></label>
                                    ...
                                    <div class="col-sm-3">
                                        <div class="form-group">
                                            <label><spring:message code="label.estimation.totalamount"></spring:message></label>
        ...
        <script type="text/javascript">
                ...
                $.get(getContextPath()+"/invoices/getid",
                    function(data){
                        if(data.message == "success"){
                            if(!(data.customobj.estimateno)){
                                $("#invoiceid").val("1");
                                $('.invidlabel').text($("#invoiceid").val());
                            }else{
                                var invoiceid = data.customobj.estimateno;
            ...
            function saveInvoice(event){
                ...
                $.post("<c:url value="/estimation/add"/>",formData ,function(data){
                    if(data.message == "success"){
                        window.location.href = "<c:url value="/estimation/add"></c:url>"+ "?message=" + data.message;
                    }
                })
                .fail(function(data) {
